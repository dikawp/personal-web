...
export const projects = [
  ...
  },
  {
    ...
    description:
      "company profile website for Rajawali Chakti Utama, a construction services company based in Surabaya, Indonesia. Built with Laravel and Tailwind CSS for a modern and responsive design.",
  ...
  },
  {
    ...
    title: "Kana Learning",
    description:
      "Kana Learning is a web application designed to help users learn the Kana writing system used in the Japanese language. It provides interactive lessons, quizzes, and resources to facilitate effective learning.",
  ...
  },
  {
    ...
    description:
      "A web-based system for managing school payment administration, featuring structured payment records and financial recap reports.",
  ...
  },
  {
    ...
    description:
      "Help Desk is a web application designed to assist users in managing and resolving issues related to Surabaya Tax services. It provides a platform for users to submit inquiries, track their status, and receive assistance from support staff.",
  ...
  },
  {
    ...
    title: "Log Viewer",
    description:
      "Log Viewer is a web application designed to help users view and analyze log files efficiently, providing features for searching, filtering, and visualizing log data.",
  ...
  },
  {
    ...
    description:
      "This is the old version of my personal website, showcasing my portfolio and skills. It is built with Next.js and Tailwind CSS, providing a responsive and modern design.",
  ...
  },
  {
    ...
    description:
      "Sistem Pemberkasan is a web application designed to manage and organize documents efficiently, providing features for uploading, searching, and categorizing files.",
  ...
  },
  {
    ...
    description:
      "This dummy project is built with Roboflow and Flask to practice neural networks and object detection, simulating the detection of accessibility features like toilets and grab bars.",
  ...
  },
  {
    ...
    description:
      "InshanityGoods is a B2C mobile application focused on selling furniture. The app is integrated with Midtrans as its payment gateway, ensuring secure and seamless transactions.",
  ...
  },
  {
    ...
    description:
      "SiTodo is a Laravel and SQL-based task management platform that helps teams create workspaces, assign tasks, and collaborate efficiently in a single, organized environment",
  ...
  },
  {
    ...
    description:
      "GnShoppu is a UI/UX concept design for a mobile application that adopts the B2C (Business-to-Customer) model.",
    image: "/projects/gnshop.webp",
    tech: [<SiFigma key="figma" />],
  ...
  },
  {
    ...
    description:
      "This website is a sliced and redesigned version of Bandai Namco’s landing page, focusing on modern and responsive UI",
