...
export function AboutSection() {
  const experiences = [
    // Internship
    {
      title: "Information Technology Programmer",
      company: "PT. Multi Spunindo Jaya, Tbk.",
      logo: "/image/msja.webp",
      date: "Nov 2025 - May 2026",
      type: "Internship",
      bullets: [
        "Maintained and developed features for the MSJSapsheetReport application based on Production department requirements.",
        "Maintained and enhanced the employee KPI management system (MSJPA) for the HR department.",
        "Managed Material and Bill of Materials (BOM) data within the company’s SAP ERP system.",
        "Served as a functional consultant and mentor for university interns on internal systems and business processes.",
      ],
    },
  ...
  return (
    <>
      ...
      >
        ...
        <p className="mb-4">
          Hello! I&apos;m Ramadika Wijaya Poetra Subijanto, an Information
          Systems graduate from Telkom University Surabaya, earning Cumlaude
          honors with a GPA of 3.71/4.00.
        </p>
        <p className="mb-4">
          I&apos;m a passionate fullstack developer with experience in building
          B2C web and mobile applications using Laravel, React Native, and .NET,
          alongside Firebase and SQL for data management. I&apos;m also skilled
          in integrating secure payment gateways like Midtrans to ensure smooth,
          user-friendly transactions.
        </p>
        <p>
          I enjoy creating solutions that are functional, intuitive, and
          impactful&mdash;covering both clean, engaging user interfaces and
          reliable backend systems. With strong leadership and organizational
          skills, I thrive in collaborative environments and am driven by
            ...
            >
              ...
              <CardContent className="ms-16 pt-0">
                <details className="group text-xs">
                  <summary className="cursor-pointer w-fit transition-colors">
